          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8 mb-12">
            ...
            <div className="text-center group">
              <div className="bg-white rounded-2xl p-6 shadow-sm h-full">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Once you agree to partner with Kupanda, your coach will develop a personalized program to support your
                  journey to realizing success during a three, six or 12-month engagement.
                </p>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="bg-white rounded-2xl p-6 shadow-sm h-full">
                ...
                <p className="text-gray-600 leading-relaxed">
                  You and your coach will start with foundational exercises to explore your motivations, opportunities,
                  and goals. From there, we'll work together to cultivate your desired outcomes.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="px-4 sm:px-8 py-8 sm:py-12" style={{ backgroundColor: "#fac0b5" }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-gray-900 mb-6">Meet Your Growth Partner</h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            <div className="p-6 sm:p-8 rounded-2xl" style={{ backgroundColor: "#fac0b5" }}>
              <div className="text-gray-900 space-y-6 leading-relaxed">
                ...
                <p>
                  Michele holds a certification in Leadership and Performance Coaching from Brown University as well as
                  her MBA and a certificate in nonprofit leadership, underscoring her commitment to lifelong growth and
                  excellence.
                </p>
              </div>
            </div>
